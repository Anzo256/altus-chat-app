...
const LeftNav = () => {
        ...
        return(
            ...
            items-center'>
                ...
                cursor-pointer'>
                    ...
                    rounded-full bg-black/[0.5] absolute
                    top-0 left-0 justify-center items-center
                ...
                items-center'>
                    <div className='flex items-center gap-2'>
                        ...
                        onClick={() =>{
                             ...
                             handleUpdateProfile(
                             "name",
                             document.getElementById("displayNameEdit"
                             ).innerText
                          );
                        }}
                        />}
  ...
  return (
    <div className={`${editProfile ? "w-[350px]" :
    "w-[80px] items-center"}   flex flex-col
    justify-between py-5 shrink-0  transition-all`}>
         ...
         {editProfile ?  editProfileContainer()
          : (
             ...
             bg-black/[0.5] absolute top-0 left-0 justify-center
